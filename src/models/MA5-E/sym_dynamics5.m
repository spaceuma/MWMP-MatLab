syms d1 a2 a3 d5 d6;
syms width1 width2 width3 width4 width5;
syms m1 m2 m3 m4 m5;
...
I11(1,1) = m1*width1^2/4 + m1*d1^2/12;
I11(2,2) = m1*width1^2/4 + m1*d1^2/12;
...
I22(1,1) = m2*width2^2/4 + m2*a2^2/12;
I22(2,2) = m2*width2^2/4 + m2*a2^2/12;
...
I33(1,1) = m3*width3^2/4 + m3*a3^2/12;
I33(2,2) = m3*width3^2/4 + m3*a3^2/12;
...
I44(1,1) = m4*width4^2/4 + m4*d5^2/12;
I44(2,2) = m4*width4^2/4 + m4*d5^2/12;
...
I55(1,1) = m5*width5^2/4 + m5*d6^2/12;
I55(2,2) = m5*width5^2/4 + m5*d6^2/12;
