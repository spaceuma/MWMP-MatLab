...
ac2 = 100*time_ratio; % Arm actuation cost
ac3 = 100*time_ratio; % Arm actuation cost
...
%         A(16:18,7:9,i) = dG;
    ...
    % Solving the SLQR problem
    [x, u, converged] = SLQ(x, x0, u, u0, dt,...
                            stateSpaceModel, quadratizedCost, config);
    ...
    if iter > maxIter
        ...
        switch converged
            ...
            case -2
                error('The SLQR algorithm failed to find a feasible control');
            otherwise
