function x = forwardIntegrateSystem(x, u, dt)
    ...
    for i = 2:size(x,2)
        ...
        % Arm velocities
        x(10:12,i) = x(10:12,i-1) + dt*x(13:15,i-1);
        % Arm accelerations
        x(13:15,i) = getB3(x(7,i-1), x(8,i-1), x(9,i-1))\...
                     (u(1:3,i-1) - ...
                     getC3(x(7,i-1), x(8,i-1), x(9,i-1), x(10,i-1), x(11,i-1), x(12,i-1))*x(10:12,i-1));
%                      getG3(x(7,i-1), x(8,i-1), x(9,i-1)));
    end
end