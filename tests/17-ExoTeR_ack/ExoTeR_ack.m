...
%                                                                         %
%        ExoTeR_ack: Script to simulate a sample fetching operation       %
...
%         end
    ...
    % W2B Speed x
    A(13,37,1) = wheelRadius/2*cos(alphaR(1));
    A(13,42,1) = -wheelRadius/2*sin(x(42,1))*u(6,1)*kappa2;
    
    % W2B Speed y
    
    % W2B Speed Heading
    A(15,13,1) = (tan(x(42,1))-(tan(x(42,1))^2+1)*x(42,1)*kappa3)/...
                 (dfy + dfx*tan(x(42,1)));
    A(15,42,1) = (x(13,1)*(tan(x(42,1))^2+1)*kappa3)/...
                 (dfy + dfx*tan(x(42,1)));
...
%     A(25:27,16:18,1) = dG;
    ...
    A(38,36,1) = -1/dt;
    A(39,36,1) = -1/dt*sin(x(42,1))/sin(alphaR(1));
    ...
    for i = 2:timeSteps
        ...
        % W2B Speed x
        A(13,37,i) = wheelRadius/2*cos(alphaR(i-1));
        A(13,42,i) = -wheelRadius/2*sin(x(42,i-1))*u(6,i-1)*kappa2;

        % W2B Speed y

        % W2B Speed Heading
        A(15,13,i) = (tan(x(42,i-1))-(x(42,i-1)*tan(x(42,i-1))^2+1)*kappa3)/...
                     (dfy + dfx*tan(x(42,i-1)));
        A(15,42,i) = (x(13,i-1)*(tan(x(42,i-1))^2+1)*kappa3)/...
                      (dfy + dfx*tan(x(42,i-1)));
...
%         A(31:35,16:20,i) = dG;
        ...
        % Wheels accelerations
        A(38,36,i) = -1/dt;
        A(39,36,i) = -1/dt*sin(x(42,i-1))/sin(alphaR(i-1));
    ...
    % Wheels speeds
    B(36,6,1) = 1;
    B(37,6,1) = sin(x(42,1))/sin(alphaR(1));
    
    % Wheels acceleration
    B(38,6,1) = 1/dt;
    B(39,6,1) = 1/dt*sin(x(42,1))/sin(alphaR(1));
    ...
    for i = 2:timeSteps
        ...
        % Wheels speeds
        B(36,6,i) = 1;
        B(37,6,i) = sin(x(42,i-1))/sin(alphaR(i-1));

        % Wheels acceleration
        B(38,6,i) = 1/dt;
        B(39,6,i) = 1/dt*sin(x(42,i-1))/sin(alphaR(i-1));
